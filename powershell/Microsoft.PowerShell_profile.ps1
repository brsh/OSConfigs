...
function Import-GeneralModules {
    param (
...
<#
    ...
    .EXAMPLE
    Remove-FromPath -folder c:\scripts\lib
    .EXAMPLE
    ".", "C:\Scripts\lib" | Remove-FromPath
#>
    [CmdletBinding()]
    param (
...
#Modules
if (test-path C:\Scripts\lib\Modules) {
    #I recommend:
    ...
    Get-ChildItem C:\Scripts\lib\Modules *.psm1 -Recurse | ForEach-Object { Import-Module $_.FullName -force }
}
else {
    #These assume the modules are stored in the "standard" locations
}
...
#Path Adjustments
Add-ToPath -folder "C:\scripts\lib.ps"
